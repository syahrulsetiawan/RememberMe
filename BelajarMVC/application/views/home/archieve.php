                ...
                <div class="row header-section">
                    <div class="col-md-7 col-7">
                        <div class="text-content">
                            ...
                            <h4>Ini adalah beberapa note yang anda simpan.</h4>
                        </div>
                    </div>
                    <div class="col-md-5 col-5">
                        <div class="illustrasi-content">
                            <img src="<?= BASEURL; ?>/img/undraw_collecting_fjjl.svg" alt=""><br>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="existNote <?= $note['kode_color']; ?> border border-secondary">
                                ...
                                <div class="form-row align-items-center">
                                    <div class="col-auto my-1">
                                        ...
                                        <?php endif; ?>
                                        <a href="<?= BASEURL; ?>/home/removeFromArchive/<?= $note['id_note']; ?>">
                                            <div class="btn button-style">
