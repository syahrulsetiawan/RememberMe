                ...
                <div class="row header-section">
                    <div class="col-md-7 col-7">
                        <div class="text-content">
                            <h2>Hello, <?= $data['profile']['fullname']; ?></h2>
                            <h4>Selamat Datang, ingin mencatat apa hari ini?</h4>
                        </div>
                    </div>
                    <div class="col-md-5 col-5">
                        <div class="illustrasi-content">
                            <img src="<?= BASEURL; ?>/img/clip-reading-books.png" alt=""><br>
                        </div>
                    </div>
                </div>
                <div class="row newNote-section">
                    <div class="col-md-2 col-1"></div>
                    <div class="col-md-8 col-10">
                        <!-- Button trigger modal -->
                        <button type="button" class="btn button-style w-100" data-toggle="modal" data-target="#newNoteModal">
                            Menambah Catatan Baru &plus;
                        </button>
                        ...
                        <div class="modal  fade" id="newNoteModal" tabindex="-1" role="dialog" aria-labelledby="newNoteModalTitle" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered w-100" role="document">
                                <form action="<?= BASEURL; ?>/home/addNew" class="w-100" method="post">
                                    <div class="modal-content w-100">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLongTitle">Menambah Catatan Baru
                                            </h5>
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                                ...
                                                <input name='title_note' type="text" class="form-control form-section" id="formGroupExampleInput" placeholder="Judul Note" data-length>
                                            </div>
                                            <div class="form-group">

                                                <textarea name="main_note" class="form-control form-section" id="exampleFormControlTextarea1" rows="15" placeholder="Tulis sesuatu"></textarea>
                                            </div>
                                            <div class="form-row align-items-center">
                                                <div class="col-auto my-1">
                                                    <select name="tglDate" class="custom-select date-tanggal">
                                                ...
                                                <div class="col-auto my-1">
                                                    <select name="blnDate" class="custom-select date-bulan">
                                                ...
                                                <div class="col-auto my-1">
                                                    <select name="thnDate" class="custom-select date-tahun">
                                                ...
                                                <div class="col-auto my-1 button-tanggal">
                                                    <div class="btn button-style">Now</div>

                                                </div>
                                                <div class="col-auto my-1">
                                                    <div class="btn button-style button-notif" id="makeNotifNote">
                                                        Jadikan Pengingat &nbsp; <i class="fa fa-bell" aria-hidden="true"></i>
                                                    </div>
                                                    <input type="number" id="notifNote" name="notifNote" hidden>
                                                </div>
                                            </div>
                                            <div class="form-row align-items-center">
                                                <input id="codeColorNew" name="codeColor" hidden>
                                                <div class="col-auto my-1">
                                                    Change your style :
                                                </div>
                                                <div class="col-auto my-1">
                                                    <div class="btn button-color red-style"> </div>
                                                </div>
                                                <div class="col-auto my-1">
                                                    <div class="btn button-color orange-style"> </div>
                                                </div>
                                                <div class="col-auto my-1">
                                                    <div class="btn button-color yellow-style"> </div>
                                                </div>
                                                <div class="col-auto my-1">
                                                    <div class="btn button-color green-style"> </div>
                                                </div>
                                                <div class="col-auto my-1">
                                                    <div class="btn button-color blue-style"> </div>
                                                </div>
                                                <div class="col-auto my-1">
                                                    <div class="btn button-color purple-style"> </div>
                                                </div>
                                                <div class="col-auto my-1">
                                                    <div class="btn button-color brown-style"> </div>
                                                </div>
                                                <div class="col-auto my-1">
                                                    <div class="btn button-color white-style"> </div>
                                                </div>
                                                <div class="col-auto my-1">
                                                    <div class="btn button-color dark-style"> </div>
                                                </div>
                                            </div>
                                            <br>
                                        </div>
