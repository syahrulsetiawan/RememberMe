                            ...
                            <div class="existNote <?= $note['kode_color']; ?> border border-secondary">
                                ...
                                <div class="form-row align-items-center">
                                    <div class="col-auto my-1">
                                        <a href="<?= BASEURL; ?>/home/removeTrash/<?= $note['id_note']; ?>">
                                    ...
                                    <div class="col-auto my-1">
                                        <!-- Button trigger modal -->
                                        <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#ModalDeleteNote<?= $note['id_note']; ?>">
                                            Hapus Permanent
                                        </button>

                                        <!-- Modal -->
                                        <div class="modal fade" id="ModalDeleteNote<?= $note['id_note']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="exampleModalLabel">Hapus Permanent</h5>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <h5><?= $note['title_note']; ?></h5>
                                                        <p><?= $note['id_note']; ?></p>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Tidak Jadi</button>
                                                        <a href="<?= BASEURL; ?>/home/delete/<?= $note['id_note']; ?>">
                                        ...
                                        <form action="<?= BASEURL; ?>/home/update/<?= $note['id_note']; ?>" method="post">
                                            <div class="modal-header">
                                                <div class="modal-title" id="exampleModalLongTitle">
                                                    <input type="text" readonly name="titleNote" class="w-100 form-control form-section <?= $note['kode_color']; ?>" value="<?= $note['title_note']; ?>">
                                                </div>
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            ...
                                            <div class="modal-body">
                                                <textarea name="mainNote" readonly class="form-control form-section <?= $note['kode_color']; ?>" rows="15"><?= $note['main_note']; ?></textarea>
                                            </div>
